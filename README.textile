...
IMPORTANT NOTE:
As of yet it is needed to copy the view_model/views/view_models/collection
...
@view_model_instance = view_model_for model_instance@
...
Call collection_view_model_for:
@collection_view_model_instance = collection_view_model_for enumerable_containing_model_instances@

Rendering a list.
@collection_view_model_instance.list@

Rendering a collection.
@collection_view_model_instance.collection@

Rendering a table.
@collection_view_model_instance.table@

Rendering a pagination.
Note: Only works if the passed parameter for collection_view_model_for is a PaginationEnumeration.
@collection_view_model_instance.pagination@
...
Will create both a first_name and last_name delegate method that filters the model value through first textilize, then h.
...
Gets a ViewModels::Model::Class instance
@view_model = view_model_for Model::Class.new@

Gets a ViewModels::<model_instance.class.name> instance
@view_model = view_model_for model_instance@

Renders the 'example' partial in view_models/model/class.
Note: Renders a format depending on the request. ../index.text will render example.text.erb.
@view_model.render_as :example@

Renders the 'example.text.erb' partial in view_models/model/class.
@view_model.render_as :example, :text@
...
Delegates current_user and logger on the view_model to the controller.
